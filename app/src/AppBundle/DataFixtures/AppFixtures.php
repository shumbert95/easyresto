...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $restaurant->setLongitude('48.8311081');
        $restaurant->setLatitude('2.374514');
        ...
        $restaurant->setCity('Paris');
        $restaurant->setLongitude('48.8546542');
        $restaurant->setLatitude('2.3359354');
        $restaurant->setPhone('0123456789');
        ...
        $restaurant->setCity('Paris');
        $restaurant->setLongitude('48.8724229');
        $restaurant->setLatitude('2.3971672');
        $restaurant->setPhone('0123456789');
